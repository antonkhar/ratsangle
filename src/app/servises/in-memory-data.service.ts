...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    const heroes = [
      ...
      longDesk: 'This is the very first of the rats that appeared. When she finds herself in a common cage with others, she immediately fights with them and shows her dominance. The most massive and toughest of rats.', photo: '/Live-Angle/src/assets/photo/kamishka.jpg' },
      { id: 2, name: 'CatKiller', shortDesk: 'The main coward in team', 
      longDesk: 'This rat was supposed to be the strongest and bravest, but it became the main coward. For a long time I was afraid to learn to jump, get out of the cage and contact people. He likes to sit in his house and sleep.', photo: '/Live-Angle/src/assets/photo/catkiller.jpg'   },
      { id: 3, name: 'Venera', shortDesk: 'A very shy rat', 
      longDesk: 'This rat has a Siamese color, Dumbo ears. Very shy and fat (similar to me), likes to fold blankets.', photo: '/Live-Angle/src/assets/photo/venera.jpg'   },
      { id: 4, name: 'Chanel', shortDesk: "She' definitely cute", 
      longDesk: 'This rat has a white color, ears are standard. The most modest and intelligent, very fastidious in food and has a weak immune system.', photo: '/Live-Angle/src/assets/photo/chanel.jpg'   },
      { id: 5, name: 'Sharlota', shortDesk: 'Like a spider, but a rat', 
      longDesk: 'This rat has a сhocolate color, Dumbo ears, the most active, perfectly teaches other rats to mess around, climbs cabinets like spider-man', photo: '/Live-Angle/src/assets/photo/sharlotta.jpg'   },
